...
CLOUDMAP_WEBAPP_SERVICE_ARN=$(aws servicediscovery create-service \
...
echo "Service regirtry $SERVICE_REGISTRY_NAME created"
...
CLOUDMAP_NODE_EXPORTER_SERVICE_ARN=$(aws servicediscovery create-service \
--name $SERVICE_REGISTRY_NAME \
--description "$SERVICE_REGISTRY_DESCRIPTION" \
--namespace-id $CLOUDMAP_NAMESPACE_ID \
